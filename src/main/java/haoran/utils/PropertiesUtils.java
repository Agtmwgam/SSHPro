...
public class PropertiesUtils {
	...
	public static String  getRepairAddress() throws IOException{
		Properties props = PropertiesUtils.loadProperties("application.properties");
		String url = "http://61.144.253.251:9999/repair";
		if(StringUtils.isNotBlank(props.getProperty("repairAddress"))){
			return props.getProperty("repairAddress");
		}
		return url;
	}
}
