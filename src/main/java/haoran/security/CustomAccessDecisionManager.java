 ...
 * <p>创建者   :	iibm 
 * 
 * <p>描   述  :   MyAccessDecisionManager.java for com.pengtu.security.ss    </p>
 * 
 * <p>最后修改 : $: 2012-10-24-下午3:37:01 v 1.0.0	 iibm   $     </p>
 * 
*/
 ...
 *
 * void decide(Authentication authentication, Object secureObject, List
 * <ConfigAttributeDefinition> config) throws AccessDeniedException; boolean
	...
	public void decide(Authentication authentication, Object object, Collection<ConfigAttribute> configAttributes)
		...
		while (ite.hasNext()) {
			...
			for (GrantedAuthority ga : authentication.getAuthorities()) {
				if ((Constants.AUTHORITY_PREFIX + needRole.trim()).equals(ga.getAuthority().trim())) {
					return;
				}
			}
		}
		throw new AccessDeniedException("对不起，您无此权限！");
